...
library.add(faGithub as unknown as IconPack); //TODO: check why and how? -> dont understand this code (autocomplete by IDE)
library.add(faLinkedin as unknown as IconPack); //TODO: check why and how? -> dont understand this code (autocomplete by IDE)
